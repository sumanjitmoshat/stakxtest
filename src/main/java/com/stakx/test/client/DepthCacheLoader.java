...
public class DepthCacheLoader {
	...
	public DepthCacheLoader(String symbol) {
	 ...
	 * @return 
	 */
	 Map<String, NavigableMap<BigDecimal, BigDecimal>> startDepthEventStreaming(String symbol) {
		BinanceApiClientFactory factory = BinanceApiClientFactory.newInstance();
		BinanceApiWebSocketClient client = factory.newWebSocketClient();
		System.out.println("indepth Streaming");
